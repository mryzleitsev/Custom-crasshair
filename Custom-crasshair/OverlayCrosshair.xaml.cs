...
public partial class OverlayCrosshair : Window
{
            ...
            if (currentProcess != null)
            {
                ...
                else
                {
                    ...
                    Dispatcher.Invoke(() =>
                    {
                        ...
                        SetWindowPos(currentWindowHandle, HWND_TOPMOST, 0, 0, 0, 0,
                        ...
                        if (errorFiredOnce)
                        {
                            ...
                            AttachedToProcessComplete?.Invoke(currentProcess.ProcessName + ".exe(" +
    ...
    private void window_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        var newThread = new Thread(Thread_loop);
        newThread.Start();
